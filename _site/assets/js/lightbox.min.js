    ...
    $.extend($.fn, {
        simpleLightboxVideo: function () {
            ...
            elements.click(function () {
                $("#slvj-window, #slvj-background-close, #slvj-back-lightbox, .slvj-lightbox, #slvj-close-icon").remove();

                var marginTop = window.innerHeight > 540 ? (window.innerHeight - 540) / 2 : 0;
                
                var videoSite = $(this).data("videosite");
                var videoFrame = videoSite === "local"
                    ? '<video width="640" height="480" id="slvj-video-embed" controls preload="metadata" playsinline autoplay><source src="" type="video/mp4"></video>'
